...
export default function Timer({ seconds, onExpire, urgentBelow = 300, testId = "quiz-timer" }) {
  ...
  return (
    <div
      ...
      className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg font-mono-num font-bold text-base sm:text-lg border ${
        urgent ? "timer-urgent border-red-300" : "bg-slate-100 text-slate-700 border-slate-200"
      }`}
    >
